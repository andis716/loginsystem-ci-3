...
class User extends CI_Controller {
	...
	public function __construct() {
		...
		parent::__construct();
		is_logged_in(); 
		// script keamanan ini di tulis di dalam file helper dalam folder helper
		// dan di konfigurasi di autoload
		}
	...
	public function editp() {
		...
		$this->load->view('templates/sidebar', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('user/editp', $data);
		$this->load->view('templates/footer');
		} else {
	...
	public function changePassword() {
		...
		$this->form_validation->set_rules('new_password2','Confirm New Password',
																			'required|trim|min_length[4]|matches[new_password1]');
